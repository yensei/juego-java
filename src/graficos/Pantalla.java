...
public final class Pantalla {
	...
	public void limpiar() {
		for(int i=0; i < pixeles.length; i++) {
			pixeles[i] = 0;//asignamos negro a todos los pixeles 
		}
	}
	...
	public void mostrarCuadro(int compesacionX, int compensacionY, Cuadro cuadro) {
		for (int y = 0; y < cuadro.sprite.getLado(); y++) {
			int posicionY = y + compensacionY;
			for (int x = 0; x < cuadro.sprite.getLado(); x++) {
				int posicionX = y + compesacionX;
